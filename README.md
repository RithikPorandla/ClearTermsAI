...
- **Local‑first**: Your API key and results stay on your device by default.

## What You’ll See
- **Risk Index** (0–100)
- **The Gist** (2 sentences)
- **Top Red Flags** with quotes
- **Your Data Rights**
...
6. Visit any Terms or Privacy page and click **Analyze This Policy**.
